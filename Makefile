...
assembler.exe: assembler.o
	g++ assembler.o $(flag) -o assembler
...
processor.exe: processor.o stackfuncs.o C_Dtor.o ReadByteFile.o
	g++ processor.o stackfuncs.o C_Dtor.o ReadByteFile.o $(flag) -o processor
