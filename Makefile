all: compilator processor clean
...
#run compilator
compilator: compilator.exe
	.\compilator.exe

compilator.exe: compilator.o
	g++ compilator.o $(flag) -o compilator

#run processor
processor: processor.exe
	.\processor.exe

processor.exe: processor.o stackfuncs.o
	g++ processor.o stackfuncs.o $(flag) -o processor
